...
ErrorHandler::register($requestStart);
...
// Register shutdown handler to log the request even when Response::json() calls exit
register_shutdown_function(function () use ($requestStart, $method, $path) {
