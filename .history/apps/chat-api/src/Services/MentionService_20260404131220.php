...
final class MentionService
{
    ...
    public static function processMentions(
        ...
        NotificationService::notifyMentions($messageId, $authorId, $userIds, $channelId, $conversationId, $threadId);
    }
    ...
    public static function reprocessMentions(
        ...
        self::processMentions($messageId, $newBody, $authorId, $channelId, $conversationId, $room, $threadId);
    }
