...
final class NotificationRepository
{
    ...
    public static function create(
        ...
        $stmt = $db->prepare(
            'INSERT INTO notifications (user_id, type, actor_id, message_id, channel_id, conversation_id, thread_id, data)
             VALUES (?, ?, ?, ?, ?, ?, ?, ?)'
        );
        $stmt->execute([
            $userId,
     ...
     */
    public static function forUser(int $userId, ?int $before = null, int $limit = self::PAGE_SIZE): array
    {
    ...
    {
        return '
            SELECT n.id, n.user_id, n.type, n.actor_id, n.message_id,
