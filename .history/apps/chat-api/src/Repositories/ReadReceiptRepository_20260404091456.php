...
final class ReadReceiptRepository
{
    ...
    public static function unreadCounts(int $userId): array
    {
        ...
        $sql = '
            ...
            JOIN messages m ON m.channel_id = cm.channel_id AND m.deleted_at IS NULL
        ...
        $sql = '
            ...
            JOIN messages m ON m.conversation_id = cvm.conversation_id AND m.deleted_at IS NULL
        ...
        return compact('channels', 'conversations');
    }
}
