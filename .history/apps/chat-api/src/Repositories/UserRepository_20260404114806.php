...
final class UserRepository
{
    ...
    /**
     * Lightweight status map for co-members: returns [userId => status].
     * Only selects id + status — much cheaper than full coMembers().
     */
    public static function coMemberStatuses(int $userId): array
    {
        $sql = '
