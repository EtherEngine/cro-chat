...
final class MessageRepository
{
    ...
    private static function cursorQuery(
        ...
        $sql = self::baseSelect() . " WHERE $where";
    ...
    public static function addAttachment(
        ...
        $db = Database::connection();
        $db->prepare(
            'INSERT INTO attachments (message_id, file_name, file_path, mime_type, file_size)
             VALUES (?, ?, ?, ?, ?)'
        )->execute([$messageId, $fileName, $filePath, $mimeType, $fileSize]);
