...
use App\Jobs\Handlers\LinkUnfurlHandler;
use App\Jobs\Handlers\NotificationDispatchHandler;
use App\Jobs\Handlers\TaskReminderHandler;
...
final class Worker
{
    ...
    private const HANDLERS = [
        ...
        'webhook.send' => WebhookSendHandler::class,
        'knowledge.summarize_thread' => KnowledgeSummarizeThreadHandler::class,
        'knowledge.summarize_channel' => KnowledgeSummarizeChannelHandler::class,
        'knowledge.extract' => KnowledgeExtractHandler::class,
        'linkpreview.unfurl' => LinkUnfurlHandler::class,
        'task.reminders' => TaskReminderHandler::class,
        'ai.summarize_thread' => AiSummarizeThreadHandler::class,
