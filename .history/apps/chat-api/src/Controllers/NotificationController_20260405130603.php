...
final class NotificationController
{
    ...
    public function index(): void
    {
        ...
        $result = NotificationRepository::forUser($userId, $before, $limit, $spaceId);
    ...
    public function unreadCount(): void
    {
        $userId = Request::requireUserId();
        $spaceId = isset($_GET['space_id']) ? (int) $_GET['space_id'] : null;
        Response::json(['unread_count' => NotificationRepository::unreadCount($userId, $spaceId)]);
    }
    ...
    public function markAllRead(): void
    {
        $userId = Request::requireUserId();
        $spaceId = isset($_GET['space_id']) ? (int) $_GET['space_id'] : null;
        $count = NotificationRepository::markAllRead($userId, $spaceId);
