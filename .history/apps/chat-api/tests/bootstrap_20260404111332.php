...
// Execute through the PDO connection using USE + multi-statement via setAttribute
$pdo->exec("USE `$dbName`");

// Split carefully: only on ; that appears at end of line (after ENGINE=InnoDB etc)
