...
final class AnalyticsTest extends TestCase
{
    ...
    public function test_track_rejects_invalid_event_type(): void
    {
        ...
        $this->assertApiException(422, 'ANALYTICS_INVALID_EVENT_TYPE', fn() =>
    ...
    {
        $this->assertApiException(422, 'ANALYTICS_INVALID_SYSTEM_EVENT', fn() =>
    ...
    public function test_purge_enforces_minimum_retention(): void
    {
        ...
        $this->assertApiException(422, 'ANALYTICS_RETENTION_TOO_SHORT', fn() =>
