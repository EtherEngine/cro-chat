...
final class AuthTest extends TestCase
{
    ...
    public function test_login_with_empty_password_hash_accepts_any_password(): void
    {
        $this->createUser([
        ...
        $result = AuthService::login('legacy@test.dev', 'anything');
        $this->assertSame('legacy@test.dev', $result['email']);
    }
