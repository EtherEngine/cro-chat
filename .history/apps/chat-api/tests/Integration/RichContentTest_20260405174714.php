...
final class RichContentTest extends TestCase
{
    ...
    {
        $this->assertApiException(422, 'SNIPPET_TITLE_INVALID', fn() =>
    ...
    {
        $this->assertApiException(422, 'SNIPPET_CONTENT_EMPTY', fn() =>
            RichContentService::createSnippet($this->space['id'], $this->user['id'], [
                'title' => 'Test',
                'content' => '',
            ])
    ...
    {
        RichContentService::createSnippet($this->space['id'], $this->user['id'], [
            'title' => 'S1', 'content' => 'a', 'language' => 'php'
        ]);
        RichContentService::createSnippet($this->space['id'], $this->user['id'], [
            'title' => 'S2', 'content' => 'b', 'language' => 'javascript'
        ]);
    ...
    public function test_delete_snippet(): void
    {
        ...
        $this->assertApiException(404, 'SNIPPET_NOT_FOUND', fn() =>
    ...
    public function test_delete_snippet_by_other_user_fails(): void
    {
        ...
        $this->assertApiException(403, 'SNIPPET_EDIT_DENIED', fn() =>
    ...
    {
        $snippet = RichContentService::createSnippet($this->space['id'], $this->user['id'], [
            'title' => 'Secret', 'content' => 'hidden', 'is_public' => false,
        ]);

        $this->actingAs($this->user2['id']);
        $this->assertApiException(403, 'SNIPPET_ACCESS_DENIED', fn() =>
    ...
    {
        $this->assertApiException(422, 'DRAFT_BODY_EMPTY', fn() =>
    ...
    public function test_delete_draft(): void
    {
        ...
        $this->assertApiException(404, 'DRAFT_NOT_FOUND', fn() =>
    ...
    public function test_other_user_cannot_delete_draft(): void
    {
        ...
        $this->assertApiException(403, 'DRAFT_DELETE_DENIED', fn() =>
    ...
    public function test_collaborator_with_view_cannot_edit(): void
    {
        ...
        $this->assertApiException(403, 'DRAFT_EDIT_DENIED', fn() =>
    ...
    public function test_add_collaborator_to_non_shared_draft_fails(): void
    {
        ...
        $this->assertApiException(422, 'DRAFT_NOT_SHARED', fn() =>
    ...
    public function test_publish_draft_twice_fails(): void
    {
        ...
        $this->assertApiException(409, 'DRAFT_ALREADY_PUBLISHED', fn() =>
            RichContentService::publishDraft($draft['id'], $this->user['id'])
        );
    }
    ...
    public function test_publish_draft_without_target_fails(): void
    {
        ...
        $this->assertApiException(422, 'DRAFT_NO_TARGET', fn() =>
            RichContentService::publishDraft($draft['id'], $this->user['id'])
        );
    }
