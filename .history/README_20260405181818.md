...
| Service    | 16     | Auth, Channel, Message, Notification, Mention, Reaction, Thread, Attachment, Presence, Role, Moderation, Job, Compliance, Push, RichContent, …                                                                  |
...
**398 Tests, 812 Assertions** (PHPUnit 11) – Integration-Tests gegen `cro_chat_test`.
