...
database/
  schema.sql         16 Tabellen (MariaDB, utf8mb4)
...
| ---------- | ------ | ------------------------------------------------------------------------------------------------- |
| Controller | 11     | Auth, Channel, Message, Conversation, Presence, Search, Attachment, Key, ReadReceipt, Space, User |
| Service    | 7      | AuthService, ChannelService, MessageService, …                                                    |
| Repository | 8      | MessageRepository, SearchRepository, KeyRepository, …                                             |
...
16 Tabellen: `users`, `spaces`, `space_members`, `channels`, `channel_members`, `conversations`, `conversation_members`, `messages`, `message_edits`, `attachments`, `user_keys`, `conversation_keys`, `read_receipts`, `rate_limits`.
...
**78 Tests, 131 Assertions** (PHPUnit 11) – Integration-Tests gegen `cro_chat_test`.
