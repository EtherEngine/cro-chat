...
27 Tabellen: `users`, `spaces`, `space_members`, `channels`, `channel_members`, `conversations`, `conversation_members`, `messages`, `message_edits`, `attachments`, `user_keys`, `conversation_keys`, `read_receipts`, `rate_limits`, `reactions`, `threads`, `mentions`, `notifications`, `domain_events`, `pinned_messages`, `saved_messages`, `moderation_actions`, `jobs`, `push_subscriptions`, `push_delivery_log`, `sync_cursors`, `vapid_keys`, …
