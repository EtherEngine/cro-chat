    ...
    <aside className="sidebar-left">
      <div className="user-profile">
        ...
        <div className="profile-actions">
          ...
          <div className="notification-bell-wrapper" data-notification-bell>
            <button className={`icon-btn${state.notificationUnread > 0 ? ' bell-has-unread' : ''}`} title="Notifications" onClick={() => setShowNotifications((v) => !v)}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
