...
final class MessageRepository
{
    ...
    private static function hydrateMany(array $rows): array
    {
        ...
        $mentionMap = MentionRepository::forMessages($ids);
        return array_map(fn($r) => self::hydrate($r, $attachmentMap, $reactionMap, $mentionMap), $rows);
    }
    ...
    public static function find(int $id): ?array
    {
        ...
        $mentionMap = MentionRepository::forMessages([$mid]);
        return self::hydrate($row, $attachmentMap, $reactionMap, $mentionMap);
    }
