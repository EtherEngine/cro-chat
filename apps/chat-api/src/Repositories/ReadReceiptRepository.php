...
final class ReadReceiptRepository
{
    ...
    public static function unreadCounts(int $userId, ?int $spaceId = null): array
    {
        $channels = [];
        $conversations = [];
        ...
        $sql = '
            ...
            JOIN conversations cv ON cv.id = cvm.conversation_id
        ...
        $sql .= ' GROUP BY cvm.conversation_id';
