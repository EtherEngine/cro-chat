...
final class SpaceRepository
{
    ...
    public static function isAdminOrOwner(int $spaceId, int $userId): bool
    {
        ...
        return $role !== null && \App\Services\RoleService::isSpaceAdminOrAbove($role);
    }

    public static function isModeratorOrAbove(int $spaceId, int $userId): bool
    {
        $role = self::memberRole($spaceId, $userId);
        return $role !== null && \App\Services\RoleService::isSpaceModeratorOrAbove($role);
    }
